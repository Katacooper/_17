...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("Bank Account : " + myBankBalanceEuro);
    }
     ...
     *    2e: The exact weight of an apple measured by scientific equipment long
    ...
    public static void exercise3() {
        ...
        System.out.println("Day in number: " + LocalDate.now().getDayOfMonth());
        ...
        System.out.println("Month number: " + LocalDate.now().getMonthValue());
        System.out.println("Before: " + LocalDate.now().isBefore(LocalDate.of(2022,12,25)));
        System.out.println("After: " + LocalDate.now().isAfter(LocalDate.of(2022,12,25)));
    }
}
